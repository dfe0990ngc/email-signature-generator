  ...
  const signatureHTML = cloudinaryUrl ? (
    <div ref={signatureRef} style={{ background: 'transparent' }}>
          ...
          <tr>
            ...
            <td style={{ verticalAlign: 'top', background: 'transparent' }}>
              ...
              <div style={{ margin: '0px 0', background: 'transparent' }}>
                <img style={{display:"inline-block"}} src="https://res.cloudinary.com/duybphdbl/image/upload/v1759619668/email-brown_lenfwx.png" width="16" height="16" alt="Email" />{' '}{' '}
              ...
              <div style={{ margin: '0px 0', background: 'transparent' }}>
                <img style={{display:"inline-block"}} src="https://res.cloudinary.com/duybphdbl/image/upload/v1759619668/phone-brown_tai1qm.png" width="16" height="16" alt="Phone" />{' '}
              ...
              {facebook && (
                <div style={{ margin: '0px 0', background: 'transparent' }}>
                  <img style={{display:"inline-block"}} src="https://res.cloudinary.com/duybphdbl/image/upload/v1759619667/facebook-brown_wkzyle.png" width="16" height="16" alt="FB" />{' '}
                  <a 
      ...
      <div style={{ marginTop: '16px', borderTop: '1px solid #e0e0e0', fontSize: '10px', color: '#888', lineHeight: '1.5', maxWidth: '500px', background: 'transparent' }}>
        {/* VMO & SB */}
        <img 
          src="https://res.cloudinary.com/duybphdbl/image/upload/v1759618393/header-wrapped_ag8r6s.png"
          alt="Logo" 
          width="100%"
          height="auto"
