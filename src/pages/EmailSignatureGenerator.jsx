...
export default function EmailSignatureGenerator() {
  ...
  const [location, setLocation] = useState('Gallego Law');
                    ...
                    <tr>
                      ...
                      <td valign="top" style={{ padding: '12px 0 8px 6px', verticalAlign: 'top' }}>
                        ...
                        <div style={{ margin: '6px 0 10px 0' }}>
                          <img
                            src="https://res.cloudinary.com/duybphdbl/image/upload/v1760533782/brown-line_uquh6f.png"
                            width="120"
                            height="3"
                            alt=""
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative bg-white shadow-md mb-4 sm:mb-6 p-4 sm:p-8 rounded-lg">
          <div className="pr-16 sm:pr-24">
            <h1 className="mb-2 font-bold text-xl sm:text-2xl lg:text-3xl leading-tight" style={{ color: selectedColor }}>📧 Email Signature Generator</h1>
